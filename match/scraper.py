...
def ScrapeMatch(match_id):
    ...
    agents = [agent_map.get(x["src"].split("agents/")[1].split("/displayicon.png")[0]) for x in soup.find_all("img", {"data-v-5ab10222": True, "data-v-24b37b6d": True, }) if ("displayicon" in x["src"])]
    ...
    if "Avg. Rank:" in str(TeamChunks[0]) and "Avg. Rank:" in str(TeamChunks[1]):
        ranks = [map_rank(e) for i, e in enumerate([x["src"] for x in soup.find_all("img", {"data-v-5ab10222": True, "data-v-24b37b6d": True, }) if ("tiersv2" in x["src"])]) if i not in [0,6]]
    elif "Avg. Rank:" in str(TeamChunks[0]):
        ranks = [map_rank(e) for i, e in enumerate([x["src"] for x in soup.find_all("img", {"data-v-5ab10222": True, "data-v-24b37b6d": True, }) if ("tiersv2" in x["src"])]) if i not in [0]]
    elif "Avg. Rank:" in str(TeamChunks[1]):
        ranks = [map_rank(e) for i, e in enumerate([x["src"] for x in soup.find_all("img", {"data-v-5ab10222": True, "data-v-24b37b6d": True, }) if ("tiersv2" in x["src"])]) if i not in [5]]
    else:
        ranks = [map_rank(e) for i, e in enumerate([x["src"] for x in soup.find_all("img", {"data-v-5ab10222": True, "data-v-24b37b6d": True, }) if ("tiersv2" in x["src"])])]
    ...
    values = [str2num(x.text) for x in soup.find_all("div", {"data-v-24b37b6d": True, "class": "value"})]
