...
def ScrapeMatch(match_id):
    ...
    agents = [agent_map.get(x["src"].split("agents/")[1].split("/displayicon.png")[0]) for x in soup.find_all("img", {"data-v-2735c5fa": True, "data-v-2a2d68ed": True, }) if ("displayicon" in x["src"])]
    ...
    if "Avg. Rank:" in str(TeamChunks[0]) and "Avg. Rank:" in str(TeamChunks[1]):
        ranks = [map_rank(e) for i, e in enumerate([x["src"] for x in soup.find_all("img", {"data-v-2735c5fa": True, "data-v-2a2d68ed": True, }) if ("tiersv2" in x["src"])]) if i not in [0,6]]
    elif "Avg. Rank:" in str(TeamChunks[0]):
        ranks = [map_rank(e) for i, e in enumerate([x["src"] for x in soup.find_all("img", {"data-v-2735c5fa": True, "data-v-2a2d68ed": True, }) if ("tiersv2" in x["src"])]) if i not in [0]]
    elif "Avg. Rank:" in str(TeamChunks[1]):
        ranks = [map_rank(e) for i, e in enumerate([x["src"] for x in soup.find_all("img", {"data-v-2735c5fa": True, "data-v-2a2d68ed": True, }) if ("tiersv2" in x["src"])]) if i not in [5]]
    else:
        ranks = [map_rank(e) for i, e in enumerate([x["src"] for x in soup.find_all("img", {"data-v-2735c5fa": True, "data-v-2a2d68ed": True, }) if ("tiersv2" in x["src"])])]
