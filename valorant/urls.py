...
urlpatterns = [
    ...
    path('analysis/sessions/', views.sessions, name='sessions'),
    path('analysis/maps/', views.maps_analysis, name='maps_analysis'),
    ...
    path('analysis/opening-duels/', views.opening_duels, name='opening_duels'),
